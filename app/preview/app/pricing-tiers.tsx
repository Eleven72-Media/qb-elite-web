...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      { label: "Create Your Own Workout Plans", included: true },
      { label: "Create Your Own Meal Plans", included: true },
      { label: "Live Film Studies", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Track Your Progress", included: true },
      { label: "Monthly Huddles", included: true },
      { label: "Weekly Workout Plans Done For You", included: true },
      { label: "Weekly Meal Plans Done For You", included: true },
      { label: "Live Film Studies", included: true },
      { label: "Dedicated Personal Coach", included: false },
      { label: "Monthly 1:1 Virtual Call", included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { label: "Track Your Progress", included: true },
      { label: "Monthly Huddles", included: true },
      { label: "Customized Weekly Workout Plans", included: true },
      { label: "Customized Weekly Meal Plans", included: true },
      { label: "Live Film Studies", included: true },
